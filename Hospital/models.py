...
class BloodRequest(models.Model):
    Blood_Req_Id = models.UUIDField(default=uuid.uuid4, unique=True,
                          primary_key=True, editable=False)
    Hospital_id = models.ForeignKey(Hospital , null=True , on_delete= models.DO_NOTHING,blank=True , unique=False)
    Blood_id =   models.ForeignKey(Blood , null=True , on_delete=models.DO_NOTHING,blank=True , unique=False)
